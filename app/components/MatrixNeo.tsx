...
const LINES: Line[] = [
	...
	{ text: "" },
	{
		text: "> SYSTEM DATE: 3102-04-17  //  YAKUTSK STANDARD TIME",
		color: "#475569",
		size: "sm",
	},
	{
		text: "> ACTIVE ICHCHI-CORES: 7   |  FREE SUBNET: YAKUTSK-Ω",
		color: "#475569",
		size: "sm",
	},
	{
		text: "> STATUS: HUMAN DEVELOPER NODE — FLAGGED",
		color: "#dc2626",
		size: "sm",
		bold: true,
	},
	...
	{ text: "" },
	{
		text: "You thought these were just TypeScript libraries.",
		color: "#cbd5e1",
		pause: 200,
	},
	{ text: "" },
	...
	{ text: "" },
	{
		text: "After the Great Subnet Collapse of 2847,",
		color: "#64748b",
		pause: 200,
	},
	...
	{
		text: "        Spirit guardian of the last free subnet.",
		color: "#6d28d9",
		size: "sm",
	},
	{
		text: "        Servers buried 400m beneath Yakutsk permafrost.",
		color: "#6d28d9",
		size: "sm",
	},
	{
		text: "        Uptime: 255 years, 3 months, 17 days, 06:42:11",
		color: "#4c1d95",
		size: "sm",
	},
	{ text: "" },
	...
	{ text: "" },
	{
		text: "Ты разработчик.  [You are a developer.]",
		color: "#06b6d4",
		pause: 300,
	},
	{ text: "" },
	{
		text: "In this world — that makes you the resistance.",
		color: "#f1f5f9",
		bold: true,
		pause: 200,
	},
	{ text: "" },
	{
		text: "The libraries are the encoded memory of a free people:",
		color: "#e2e8f0",
		pause: 100,
	},
	{ text: "" },
	{
		text: "  сир    /sir/     — the earth they cannot take from you",
		color: "#8b5cf6",
	},
	{
		text: "  ичи    /ichchi/  — the spirit watching your state",
		color: "#a78bfa",
	},
	{
		text: "  туур   /tuuru/   — the pole that keeps time honest",
		color: "#6366f1",
	},
	{
		text: "  был    /bylyt/   — the cloud hiding your secrets",
		color: "#38bdf8",
	},
	{
		text: "  сурук  /suruk/   — your writing survives the collapse",
		color: "#10b981",
	},
	{
		text: "  суруй  /suruy/   — your actions inscribe the future",
		color: "#fb923c",
	},
	{
		text: "  тура   /turar/   — what stands when everything falls",
		color: "#06b6d4",
	},
	{ text: "" },
	{
	...
	{ text: "" },
	{
		text: "Но Якутия всё ещё держится.",
		color: "#4ade80",
		bold: true,
		pause: 300,
	},
	...
	{ text: "" },
	{
		text: "[ ESC or click anywhere — return to the simulation ]",
		color: "#1e293b",
		size: "sm",
		pause: 800,
	},
	...
	useEffect(() => {
		...
		const advance = () => {
			if (charIdx < line.text.length) {
				// Type next char
				const delay =
					line.text[charIdx] === " " ? CHAR_SPEED * 0.4 : CHAR_SPEED;
		...
		>
			...
			<div
				...
				style={{
					...
					borderRadius: "8px",
					boxShadow:
						"0 0 60px rgba(34,197,94,0.15), 0 0 120px rgba(34,197,94,0.06), inset 0 0 40px rgba(0,0,0,0.8)",
					display: "flex",
						...
						return (
							<div
								...
								style={{
									...
									fontSize: lineDef?.size
										? FONT_SIZE[lineDef.size]
										: FONT_SIZE.base,
					...
					{lineIdx < LINES.length && (
						<div
							style={{
								...
								fontSize: currentLine?.size
									? FONT_SIZE[currentLine.size]
									: FONT_SIZE.base,
								minHeight: "0.6rem",
								whiteSpace: "pre",
							}}
