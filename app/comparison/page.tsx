...
function SirFormsExample() {
	...
	const handleSubmit = useFormSubmit(submitContactForm, {
		onSuccess: (data: any) =>
			setResult(`✅ sir-forms: Success! ${data?.name || "Form submitted"}`),
					...
					<div
						style={{
							...
							background: result.startsWith("✅")
								? "rgba(16,185,129,0.1)"
								: "rgba(239,68,68,0.1)",
							color: result.startsWith("✅") ? "#10b981" : "#ef4444",
							borderRadius: "7px",
							fontSize: "0.8rem",
		...
		<div>
			...
			<form ref={formRef} action={action}>
				...
				<button
					...
					disabled={pending}
					style={{
						background: "linear-gradient(135deg,#831843,#f5576c)",
						color: "white",
						border: "none",
						borderRadius: "8px",
						padding: "0.55rem 1.1rem",
...
const COMPARISON_ROWS = [
	...
	[
		"Best For",
		"Complex forms, controlled inputs, rich UX",
		"Simple forms, server-first, progressive enhancement",
	],
];
				...
				<div style={{ maxWidth: 1200, margin: "0 auto", padding: "2rem" }}>
							...
							<div>
								...
								<h1
									style={{
										...
										margin: "0 0 0.5rem",
										background:
											"linear-gradient(135deg,#e2e8f0,#a78bfa,#fb7185)",
								...
								>
									Side-by-side feature matrix and live form demos — see the same
									form built two different ways.
								</p>
							</div>
							<div
								style={{
					...
					>
						...
						>
							...
							>
								...
								>
									{[
										"Fine-grained control over field state",
										"Complex, multi-step forms",
										"Client-side validation is key",
										"Controlled components required",
										"Rich React-heavy UX",
										"Custom field hooks needed",
									].map((t) => (
										<li
											key={t}
											style={{
							...
							>
								...
								>
									Choose suruy-form-actions when:
								</h3>
								<ul
									style={{
										listStyle: "none",
								...
								>
									{[
										"Bundle size matters (~3KB)",
										"Progressive enhancement required",
										"Server-first validation preferred",
										"Simple to medium complexity forms",
										"Zero-config built-in validator",
										"SEO and no-JS scenarios matter",
									].map((t) => (
										<li
											key={t}
											style={{
						...
						>
							...
							<span style={{ color: "#94a3b8", fontSize: "0.85rem" }}>
								You can use{" "}
								<strong style={{ color: "#fb7185" }}>suruy-form-actions</strong>{" "}
								for simple forms (login, newsletter, contact) and{" "}
								<strong style={{ color: "#a78bfa" }}>sir-forms</strong> for
								complex ones (checkout, profile editor, admin panels) — see the{" "}
								<Link
									href="/hybrid"
									style={{
										color: "#f59e0b",
					...
					>
						<p style={{ fontSize: "0.8rem" }}>
							...
							<Link
								href="/hybrid"
								style={{ color: "#fb7185", textDecoration: "none" }}
							>
								Hybrid Demo →
							</Link>
							<span style={{ color: "#1e293b", margin: "0 0.75rem" }}>·</span>
