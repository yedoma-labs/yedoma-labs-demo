...
const npm = (pkg: string) =>
	`https://www.npmjs.com/package/@yedoma-labs/${pkg}`;
...
const DEMOS = [
	...
	},
	{
		...
		desc: "JSX email templates, 45 templates, 6 providers (+ mailpit), sendBatch + rate limiting, webhooks, WCAG AA dark mode, 32 design tokens",
...
const LIBRARIES = [
	{
		name: "sir-forms",
		version: PKG["sir-forms"],
		desc: "Type-safe server actions (React 19 compatible)",
		color: "#8b5cf6",
	},
	{
		name: "suruy-form-actions",
		version: PKG["suruy-form-actions"],
		desc: "Progressive enhancement forms (~3KB, zero-dep validator)",
		color: "#fb923c",
	},
	{
		name: "ichchi-state",
		version: PKG["ichchi-state"],
		desc: "Atomic state management with persistence & cross-tab sync",
		color: "#a78bfa",
	},
	{
		name: "bylyt-env-guard",
		version: PKG["bylyt-env-guard"],
		desc: "Environment variable validation with type safety",
		color: "#06b6d4",
	},
	{
		name: "suruk-logger",
		version: PKG["suruk-logger"],
		desc: "Winston-compatible Pino wrapper (5-10× faster)",
		color: "#10b981",
	},
	{
		name: "turar-config",
		version: PKG["turar-config"],
		desc: "Hot-reload config — YAML, TOML, JSON, Vault integration",
		color: "#38bdf8",
	},
	{
		name: "tuuru-chrono-tz",
		version: PKG["tuuru-chrono-tz"],
		desc: "TypeScript-first date/time — 568 IANA zones, 86 locales",
		color: "#6366f1",
	},
	{
		name: "tierde-mail",
...
const LEXICON = [
	...
	},
	{
		...
		lib: "ichchi-state",
		sakha: "ичи",
		meaning: "spirit · guardian · keeper",
	...
	},
	{
		...
		lib: "tuuru-chrono-tz",
		sakha: "туур",
		meaning: "pole · pillar · sacred post",
      ...
      `}</style>
			...
			<div
				style={{
					...
					height: "3px",
					background:
						"linear-gradient(transparent, rgba(99,102,241,0.12), transparent)",
			...
			>
				...
				<div
					style={{
						...
						background:
							"linear-gradient(135deg, #0f0c29 0%, #1a1040 30%, #0c1a30 60%, #0f1629 100%)",
						backgroundSize: "200% 200%",
						animation:
							"border-flow 6s ease infinite, pulse-neon 4s ease-in-out infinite",
						position: "relative",
						overflow: "hidden",
						textAlign: "center",
					}}
				>
					...
					<div
						style={{
							...
							pointerEvents: "none",
							background:
								"linear-gradient(45deg, transparent 20%, rgba(99,102,241,0.08) 40%, rgba(6,182,212,0.06) 60%, transparent 80%)",
					...
					<div
						style={{
							...
							pointerEvents: "none",
							background:
								"linear-gradient(135deg, transparent 30%, rgba(167,139,250,0.05) 50%, rgba(16,185,129,0.04) 70%, transparent 90%)",
					...
					<div style={{ position: "relative" }}>
						...
						<h1
							style={{
								...
								margin: "0 0 0.5rem",
								background:
									"linear-gradient(135deg, #e2e8f0 0%, #a78bfa 40%, #06b6d4 70%, #34d399 100%)",
						...
						>
							...
							<a
								href="https://github.com/yedoma-labs"
								target="_blank"
						...
						>
							...
							<a
								href="https://www.npmjs.com/~yedoma-labs"
								target="_blank"
								rel="noopener noreferrer"
								className="ext-link"
								style={{
									...
									padding: "0.45rem 1.1rem",
									borderRadius: "8px",
									background: "rgba(203,56,51,0.12)",
									border: "1px solid rgba(203,56,51,0.3)",
									color: "#fca5a5",
									fontSize: "0.82rem",
									fontWeight: 600,
								}}
				...
				<section style={{ marginBottom: "4rem" }}>
					<div
						style={{
							...
							background:
								"linear-gradient(135deg, #0a0d1a 0%, #0f0c29 40%, #060f1e 100%)",
							position: "relative",
						}}
					>
						{/* Aurora stripe */}
						<div
							style={{
								...
								height: "3px",
								background:
									"linear-gradient(90deg, #6366f1, #06b6d4, #34d399, #a78bfa, #6366f1)",
						...
						<div style={{ padding: "3rem" }}>
							...
							>
								...
								<div>
									...
									>
										YEDOMA /ˈjɛdəmə/ — Pleistocene permafrost deposits, NE
										Siberia
									</p>
									<p
										style={{
									...
									>
										<strong style={{ color: "#e2e8f0" }}>Yedoma</strong> are
										ancient permafrost deposits found beneath the soil of
										northeast Siberia — ice-rich terrain formed over{" "}
										<strong style={{ color: "#a78bfa" }}>
											10,000 years ago
										</strong>{" "}
										during the last ice age. Organic matter, seeds, even
										mammoths — frozen in time. Waiting.
									</p>
									<p
										style={{
											color: "#64748b",
									...
									>
										We name this project after yedoma because good software is
										like permafrost: forged under pressure, preserved against
										entropy,{" "}
										<em style={{ color: "#94a3b8" }}>
											enduring long after its origin is forgotten
										</em>
										.
									</p>
								</div>
								...
								<div>
									...
									>
										SAKHA REPUBLIC — largest federal subject of Russia (3.08M
										km²)
									</p>
									<p
										style={{
									...
									>
										The{" "}
										<strong style={{ color: "#e2e8f0" }}>Sakha Republic</strong>{" "}
										spans the Russian Far East — a territory larger than
										Argentina, home to the{" "}
										<strong style={{ color: "#06b6d4" }}>
											Sakha (Yakut) people
										</strong>
										, their shamanistic tradition, the world's coldest inhabited
										settlements, and skies lit by the aurora borealis
										year-round.
									</p>
									<p
										style={{
									...
									>
										...
										<strong style={{ color: "#94a3b8" }}>Sakha language</strong>{" "}
										— the indigenous tongue of Yakutia, spoken by ~500,000
										people across the Siberian taiga.
									</p>
								</div>
							</div>
							...
							<div
								style={{
									...
									margin: "0 0 2rem",
									background:
										"linear-gradient(90deg, transparent, rgba(99,102,241,0.3), rgba(6,182,212,0.25), transparent)",
								}}
							/>
							...
							>
								...
								>
									...
									<strong style={{ color: "#a78bfa", fontFamily: "monospace" }}>
										ichchi
									</strong>{" "}
									— an inner spirit or guardian. The Sakha believe no object is
									inert. Every piece of software has a spirit too: the state it
									guards, the data it shapes, the time it measures. We build
									libraries that deserve their ichchi.
								</p>
							</div>
						</div>
					</div>
				...
				<footer style={{ borderTop: "1px solid #1e293b", paddingTop: "3rem" }}>
					...
					>
						<h2 style={{ color: "#f1f5f9", margin: 0, fontSize: "1.4rem" }}>
							📦 Libraries Used
						</h2>
						<div style={{ display: "flex", gap: "0.6rem" }}>
							...
							<a
								...
								style={{
									...
									padding: "0.35rem 0.85rem",
									borderRadius: "7px",
									background: "rgba(203,56,51,0.1)",
									border: "1px solid rgba(203,56,51,0.25)",
									color: "#fca5a5",
									fontSize: "0.78rem",
									fontWeight: 600,
								}}
					...
					>
						🔒 <strong style={{ color: "#f59e0b" }}>bylyt-env-guard</strong> —
						demo mode active. Form submissions log to the server console instead
						of real API calls.
					</div>
				</footer>
			</main>
