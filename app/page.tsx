...
const LIBRARIES = [
  ...
  { name: 'tierde-mail',        version: PKG['tierde-mail'],        desc: '45 JSX email templates, 6 providers, sendBatch + rate limiting, webhooks, WCAG AA', color: '#ef4444' },
]
...
const LEXICON = [
  ...
  {
    name: 'tierde',     lib: 'tierde-mail',          sakha: 'тиэрдэ', meaning: 'to deliver · to convey · to transmit',
